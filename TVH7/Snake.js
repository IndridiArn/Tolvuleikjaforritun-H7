...
Snake.prototype.collidesWith = function (){
  ...
  for(var i = 0; i < g_snakePlayer1.trail.length-10; i++){
      ...
      if(d < 5){
        ...
        g_snakePlayer2.halt();
        console.log("Player 1 hit his own tail, player 2 wins!");
      }
  }
  ...
  for(var i = 0; i < g_snakePlayer2.trail.length-10; i++){
      ...
      if(d < 5){
        ...
        g_snakePlayer2.halt();
        console.log("Player 2 hit his own tail, player 1 wins!");
      }
  }
  ...
  for(var i = 0; i < g_snakePlayer2.trail.length-1; i++){
      ...
      if(d < 5){
        ...
        endingSoundEffects[selectedplayers[0]].play();
        g_snakePlayer2.halt();
        console.log("Player 1 hit player 2's tail, player 2 wins!");
      }
  }
  ...
  for(var i = 0; i < g_snakePlayer1.trail.length-1; i++){
      ...
      if(d < 5){
        ...
        endingSoundEffects[selectedplayers[1]].play();
        g_snakePlayer2.halt();
        console.log("Player 2 hit player 1's tail, player 1 wins!");
      }
  }
  ...
  if(this.cx < 0 || this.cx > 1190 || this.cy < 0 || this.cy > 990){
        ...
        g_snakePlayer2.halt();
        if(this.number === 1)
          console.log("Player 1 hit the wall, player 2 wins!");
        if(this.number === 2)
          console.log("Player 2 hit the wall, player 1 wins!");
