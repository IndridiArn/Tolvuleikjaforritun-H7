...
function checkWin() {
  ...
  if (g_snakePlayer1.dead === true || g_botPlayer1.dead === true) countDead = countDead + 1
  if (pickedplayers >= 2)
  ...
  if (deadPlayers === pickedplayers && pickedplayers === 1) {
    if (g_botPlayer1.dead === false) {
      winner = "Tölvan"
      winnerCol = g_botPlayer1.color
    }
    if (g_snakePlayer1.dead === false) {
      winner = "Leikmaður 1"
      winnerCol = g_snakePlayer1.color
...
function gameReset() {
  ...
  if (gameOver === true) {
    ...
    g_botPlayer1.cx = 950
    g_botPlayer1.cy = 500
    g_botPlayer1.dead = false
    g_botPlayer1.wrap = false
    g_botPlayer1.dir = 4
    g_botPlayer1.vel = 4
    g_botPlayer1.trail = []
    g_botPlayer1.rTrail = []
    g_botPlayer1.oldTrails = []
    g_botPlayer1.particles = []
    g_botPlayer1.rTrail.startX = g_botPlayer1.cx;
    g_botPlayer1.rTrail.startY = g_botPlayer1.cy;
